...
RUN yum -y update 
RUN yum -y install iproute net-tools telnet bind-utils hostname less vim more gawk sed grep sudo bash tcsh git make gcc-c++ perl cmake coreutils ntp iputils emacs cloud-init curl openssh-server passwd initscripts
